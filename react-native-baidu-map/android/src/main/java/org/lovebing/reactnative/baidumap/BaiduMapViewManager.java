...
public class BaiduMapViewManager extends ViewGroupManager<MapView> {
    ...
    private static Polyline mMarkerPolyLine=null;
   ...
   @ReactProp(name = "polyline")
    public void setPolyline(MapView mapView, ReadableArray options) {
         ...
         String[]strArray=linkInfo.split(";"); 
        ...
        map.setOnMarkerClickListener(new BaiduMap.OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(Marker marker) {
                if(marker.getTitle().length() > 0) {
                    ...
                    infoWindow = new InfoWindow(textView,position,-90,listener);
                ...
                writableMap.putInt("index",marker.getZIndex());
