...
@property (weak, nonatomic) YUDatePicker *datePicker;
@end

@implementation ViewController

-(YUDatePicker*)datePicker{
    YUDatePicker *datePicker = [ [ YUDatePicker alloc] initWithFrame:CGRectMake(0, 0, self.view.frame.size.width, 400)];
...
- (IBAction)sss:(id)sender {
    [UIView animateWithDuration:2 animations:^{
        [_datePicker setFrame:CGRectMake(0, 0, self.view.frame.size.width, 0)];
        _datePicker.alpha = 0;
