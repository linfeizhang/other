...
typedef enum{
    ...
    BMK_SEARCH_AMBIGUOUS_KEYWORD = 1,///<检索词有岐义
    BMK_SEARCH_AMBIGUOUS_ROURE_ADDR = 2,///<检索地址有岐义
    BMK_SEARCH_NOT_SUPPORT_BUS = 3,///<该城市不支持公交搜索
    BMK_SEARCH_NOT_SUPPORT_BUS_2CITY = 4,///<不支持跨城市公交
    BMK_SEARCH_RESULT_NOT_FOUND = 5,///<没有找到检索结果
    BMK_SEARCH_ST_EN_TOO_NEAR = 6,///<起终点太近
    BMK_SEARCH_KEY_ERROR = 7,///<key错误
    BMK_SEARCH_NETWOKR_ERROR = 8,///网络连接错误
    BMK_SEARCH_NETWOKR_TIMEOUT = 9,///网络连接超时
    BMK_SEARCH_PERMISSION_UNFINISHED = 10,///还未完成鉴权，请在鉴权通过后重试
